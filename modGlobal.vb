...
Module modGlobal
    ...
    Public lumen_specL, lumen_specH As Double
    ...
    Public Sub LoadEllipses(ByVal num As Integer)
        ...
        'FName = Application.StartupPath & "\" & BinType & "_Linear.cfg"
        FName = Application.StartupPath & "\" & BaseFN & "_Linear.cfg"
        ...
        lumen_specL = stemp.Substring(0, stemp.IndexOf(","))
        lumen_specH = stemp.Substring(stemp.IndexOf(",") + 1)
    ...
    Public Sub Calculate(ByVal num As Integer)
        ...
        aResultPack(1) = FormatNumber(lumens * dFactors(0), 1)                                 'fill in aresultpack array
        aResultPack(2) = flux
